...
/* harmony import */ var _img_logo_svg__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../img/logo.svg */ "./src/img/logo.svg");
/* harmony import */ var _font_Genjiro_otf__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ../font/Genjiro.otf */ "./src/font/Genjiro.otf");
...
menuImage.src = _img_logo_svg__WEBPACK_IMPORTED_MODULE_32__["default"];
...
function animate() {
  ...
  ennemies.forEach(function (ennemy, index) {
    ...
    } else if (ennemy.collidable && player.position.x + player.width - 140 >= ennemy.position.x && player.position.y + player.height - 128 >= ennemy.position.y && player.position.x <= ennemy.position.x + ennemy.width - 140 && player.position.y <= ennemy.position.y + ennemy.height) {
